...
public class boj14889 {
    ...
    static void setTeamList(int depth, int index, int[] team){ //팀 조합 구하기.
        if(depth == N/2){
            int[] temp = new int[N];
    ...
    static void dfsStartScore(int depth, int index, int[] startArray, int[] team){ // 링크 팀 합 구하기
        if(depth==2){
    ...
    static void dfsLinkScore(int depth, int index, int[] linkArray, int[] team){ //링크 팀 조합 구하기
        if(depth==2){
